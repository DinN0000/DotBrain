...
> 2026-02-15 | Security Architect Review (2026-02-21 updated)
> Scope: Full codebase security audit (v1.5.7 기준, 주요 이슈 수정 완료. SEC-001 HKDF 전환 완료 반영)
...
#### [RESOLVED] SEC-001: 키 파생에 KDF 미사용 -> HKDF 전환 완료

| 항목 | 내용 |
|------|------|
| 심각도 | ~~High~~ **Resolved** |
| OWASP | A02 (Cryptographic Failures) |
| 위치 | `KeychainService.swift:61-73` |
| 해결일 | 2026-02 |

**해결**: HKDF<SHA256> 키 파생으로 전환 완료. V1(SHA256) → V2(HKDF) 자동 마이그레이션 지원.
...
let derived = HKDF<SHA256>.deriveKey(
    ...
    salt: Data(saltV2.utf8),  // "dotbrain-kdf-salt-v2"
...
**파일들**: `NoteEnricher.swift`, `Classifier.swift`, `LinkAIFilter.swift`
...
| ID | 조치 | 난이도 |
|----|------|--------|
| ~~SEC-001~~ | ~~SHA256 -> HKDF 키 파생 전환~~ **완료** | - |
